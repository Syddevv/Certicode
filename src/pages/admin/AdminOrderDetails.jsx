        ...
        <main className="main admin-order-main">
          ...
          >
            <span className="verified-badge">
              <span className="dot-green">●</span> Payment Verified
            </span>
              ...
              <div className="order-main-content">
                  ...
                  <div className="order-header-split">
                    <div>
                      ...
                      <p className="meta-text">
                        Placed on Dec 5, 2025 at 13:24 PM
                      </p>
                    </div>
                ...
                <div className="card">
                  ...
                  <div className="timeline-horizontal">
                    ...
                    <div className="t-step">
                      <div className="t-icon green">
                        <img
                          src={transactionCompIcon}
              ...
              <aside className="order-sidebar">
                ...
                <div className="card customer-card">
                  ...
                  <div className="info-group">
                    ...
                    <a href="mailto:j.wilson@enterprisesol.com">
                      j.wilson@enterprisesol.com
                    </a>
                  </div>
                ...
                <div className="refund-section">
                  <button className="btn-refund">↺ Refund Order</button>
                </div>
